...
template <int MAX_K>
inline bool KCASValidate<MAX_K>::validate(kcasptr_t snapshot, kcastagptr_t tagptr)
{
...
template <int MAX_K>
inline bool KCASValidate<MAX_K>::validate()
{
...
template <int MAX_K>
inline bool KCASValidate<MAX_K>::execute()
{
...
template <int MAX_K>
inline bool KCASValidate<MAX_K>::validateAndExecute()
{
        assert(kcas_tid.getId() != -1);
        auto desc = &kcasDescriptors[kcas_tid.getId()];
...
template <int MAX_K>
casword_t KCASValidate<MAX_K>::readPtr(casword_t volatile *addr)
{
        casword_t r;
        do
        {
...
template <int MAX_K>
casword_t KCASValidate<MAX_K>::readVal(casword_t volatile *addr)
{
        return ((casword_t)readPtr(addr)) >> KCAS_LEFTSHIFT;
}

template <int MAX_K>
void KCASValidate<MAX_K>::writeInitPtr(casword_t volatile *addr, casword_t const newval)
{
        *addr = newval;
}

template <int MAX_K>
void KCASValidate<MAX_K>::writeInitVal(casword_t volatile *addr, casword_t const newval)
{
...
template <int MAX_K>
kcasptr_t KCASValidate<MAX_K>::getDescriptor()
{
...
template <int MAX_K>
template <typename T>
void KCASValidate<MAX_K>::add(casword<T> *caswordptr, T oldVal, T newVal)
{
