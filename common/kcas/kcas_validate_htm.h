...
{
    volatile casword_t value;
    casword<casword_t> *volatile word;
};
...
template <int MAX_K>
inline bool KCASValidateHTM<MAX_K>::validate(kcasptr_t snapshot, kcastagptr_t tagptr)
{
...
template <int MAX_K>
inline bool KCASValidateHTM<MAX_K>::validate()
{
...
template <int MAX_K>
casword_t KCASValidateHTM<MAX_K>::rdcssRead(casword_t volatile *addr)
{
    casword_t r;
    do
    {
...
template <int MAX_K>
bool KCASValidateHTM<MAX_K>::validateAndExecuteOld()
{
    assert(kcas_tid.getId() != -1);
    auto desc = &kcasDescriptors[kcas_tid.getId()];
    desc->validationRequired = 1;
...
template <int MAX_K>
casword_t KCASValidateHTM<MAX_K>::readPtr(casword_t volatile *addr)
{
    casword_t r;
    do
    {
...
template <int MAX_K>
casword_t KCASValidateHTM<MAX_K>::readVal(casword_t volatile *addr)
{
    return ((casword_t)readPtr(addr)) >> KCAS_LEFTSHIFT;
}

template <int MAX_K>
void KCASValidateHTM<MAX_K>::writeInitPtr(casword_t volatile *addr, casword_t const newval)
{
    *addr = newval;
}

template <int MAX_K>
void KCASValidateHTM<MAX_K>::writeInitVal(casword_t volatile *addr, casword_t const newval)
{
...
template <int MAX_K>
template <typename T>
void KCASValidateHTM<MAX_K>::add(casword<T> *caswordptr, T oldVal, T newVal)
{
