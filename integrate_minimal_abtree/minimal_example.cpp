...
int main(int argc, char** argv) {
    ...
    const int ANY_KEY = 0;
    const int does_not_matter1 = 0;
    void * const does_not_matter2 = NULL;
    Random * const does_not_matter3 = NULL;
    const int NUM_THREADS = 1;
    
    auto tree = new ds_adapter<int, void *>(ANY_KEY, does_not_matter1, does_not_matter2, NUM_THREADS, does_not_matter3);
