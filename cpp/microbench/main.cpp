...
void execute(globals_t* g, Parameters* parameters) {
    ...
    for (int i = 0; i < parameters->getNumThreads(); ++i) {
        /* threads[i] = new std::thread(&ThreadLoop::run, threadLoops[i]); */
           threads[i] = new std::thread([tl = threadLoops[i], &json, &m] {

							/* int fd_l1_miss, fd_l1_access, l1_miss, l1_access; */
							/* int fd_ll_miss, fd_ll_access, ll_miss, ll_access; */
							/* int fd_cache_miss, fd_cache_access, cache_miss, cache_access; */
							/*        int fd_ref_cyc; */
							/*        uint64_t ref_cyc; */
							/* if constexpr (Counting) { */
							/* 	fd_l1_miss = init_counter(PERF_TYPE_HW_CACHE, */
							/* 		 PERF_COUNT_HW_CACHE_L1D | (PERF_COUNT_HW_CACHE_OP_READ << 8) | (PERF_COUNT_HW_CACHE_RESULT_MISS << 16)); */
							/* 	fd_l1_access = init_counter(PERF_TYPE_HW_CACHE, */
							/* 		 PERF_COUNT_HW_CACHE_L1D | (PERF_COUNT_HW_CACHE_OP_READ << 8) | (PERF_COUNT_HW_CACHE_RESULT_ACCESS << 16)); */
							/**/
							/* 	fd_ll_miss = init_counter(PERF_TYPE_HW_CACHE, */
							/* 		 PERF_COUNT_HW_CACHE_LL | (PERF_COUNT_HW_CACHE_OP_READ << 8) | (PERF_COUNT_HW_CACHE_RESULT_MISS << 16)); */
							/* 	fd_ll_access = init_counter(PERF_TYPE_HW_CACHE, */
							/* 		 PERF_COUNT_HW_CACHE_LL | (PERF_COUNT_HW_CACHE_OP_READ << 8) | (PERF_COUNT_HW_CACHE_RESULT_ACCESS << 16)); */
							/**/
							/* 	fd_cache_access = init_counter(PERF_TYPE_HARDWARE, PERF_COUNT_HW_CACHE_REFERENCES); */
							/* 	fd_cache_miss = init_counter(PERF_TYPE_HARDWARE, PERF_COUNT_HW_CACHE_MISSES); */
							/* 	fd_ref_cyc = init_counter(PERF_TYPE_HARDWARE, PERF_COUNT_HW_REF_CPU_CYCLES); */
							/* } */
							/**/
							tl->run();
							/**/
							/* if constexpr (Counting) { */
							/* 	l1_miss = deinit_counter(fd_l1_miss); */
							/* 	l1_access = deinit_counter(fd_l1_access); */
							/**/
							/* 	ll_miss = deinit_counter(fd_ll_miss); */
							/* 	ll_access = deinit_counter(fd_ll_access); */
							/**/
							/* 	cache_miss = deinit_counter(fd_cache_miss); */
							/* 	cache_access = deinit_counter(fd_cache_access); */
							/*          ref_cyc = deinit_counter(fd_ref_cyc); */
							/**/
							/* 	std::lock_guard lg(m); */
							/* 	std::stringstream ss; */
							...
							/* 	auto key = ss.str(); */
							/* 	auto ds = */
							/* 	json["ds"] = STRINGIFY(DS_TYPENAME); */
							/* 	json[key]["cache_refs"] = cache_access; */
							/* 	json[key]["cache_miss"] = cache_miss; */
							/* 	json[key]["l1_access"] = l1_access; */
							/* 	json[key]["l1_miss"] = l1_miss; */
							/* 	json[key]["ll_access"] = ll_access; */
							/* 	json[key]["ll_miss"] = ll_miss; */
							/* 	json[key]["ref_cycles"] = ref_cyc; */
							/**/
							/* 	COUTATOMIC("thread " << std::this_thread::get_id() */
							/* 			<< "\n\tcache_refs: " << cache_access */
