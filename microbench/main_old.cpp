...
//    PAD;
//    BenchParameters<test_type> * benchParameters;
...
//    PAD;
//
//    globals_t(size_t maxkeyToGenerate, BenchParameters * _benchParameters)
////            KeyGeneratorBuilder<test_type> *_keyGeneratorBuilder)
...
//    parameters->TOTAL_THREADS = parameters->WORK_THREADS + parameters->RQ_THREADS;
    ...
    main_continued_with_globals(new globals_t(parameters->MAXKEY, benchParameters));
