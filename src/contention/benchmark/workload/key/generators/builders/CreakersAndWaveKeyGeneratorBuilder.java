...
import contention.benchmark.workload.key.generators.impls.CreakersAndWaveKeyGenerator;
...
public class CreakersAndWaveKeyGeneratorBuilder implements KeyGeneratorBuilder {
    ...
    public CreakersAndWavePrefillKeyGeneratorBuilder generateDefaultPrefillKeyGeneratorBuilder() {
        return new CreakersAndWavePrefillKeyGeneratorBuilder(parameters);
    }

    @Override
    public CreakersAndWaveKeyGeneratorBuilder init(int range) {
